...
//cases for workouts
        String workout;
        switch (num) {
            case 1: workout = "Push-ups";
                break;
            case 2: workout = "Sit-ups";
                break;
            case 3: workout = "Pull-ups";
                break;
            case 4: workout = "Dips";
                break;
            case 5: workout = "Chest press";
                break;
            default: workout = "Run"; //if the number is 0, then run is chosen
                break;
        }
